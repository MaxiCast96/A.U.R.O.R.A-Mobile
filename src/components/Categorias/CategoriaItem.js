...
import { Eye, Edit3, Trash2, Cube, Image as ImageIcon } from 'lucide-react-native';
                ...
                <View style={styles.categoriaHeader}>
                    <View style={styles.iconContainer}>
                        {categoria.icono && categoria.icono.includes('http') ? (
                            <ImageIcon size={24} color="#009BBF" />
                        ) : (
                            <Cube size={24} color="#009BBF" />
                        )}
                    </View>
