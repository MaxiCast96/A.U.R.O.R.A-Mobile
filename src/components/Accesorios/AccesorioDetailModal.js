...
/**
 * Componente AccesorioDetailModal
 * 
 * Modal que muestra toda la información detallada de un accesorio
 * con un diseño moderno siguiendo el patrón de LenteDetailModal.
 * 
 * Props:
 * @param {boolean} visible - Controla la visibilidad del modal
 * @param {Object} accesorio - Objeto con la información del accesorio
 * @param {number} index - Índice del accesorio en la lista
 * @param {Function} onClose - Función que se ejecuta al cerrar el modal
 * @param {Function} onEdit - Función que se ejecuta al editar accesorio
 */
const AccesorioDetailModal = ({ visible, onClose, accesorio, index, onEdit }) => {
  ...
  const renderImageGallery = () => {
    if (!accesorio.imagenes || accesorio.imagenes.length === 0) {
      return (
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <Text style={styles.headerTitle}>Detalle de Accesorio</Text>
            <Text style={styles.headerSubtitle}>Accesorio #{(index || 0) + 1}</Text>
          </View>
          <TouchableOpacity 
        ...
        >
          ...
          <View style={styles.productSection}>
            ...
            <View style={styles.productInfo}>
              ...
              <View style={[
                ...
                { backgroundColor: getMaterialColor(accesorio.material) }
              ]}>
                <Text style={styles.materialText}>
                  {accesorio.material || 'Sin material'}
                </Text>
              </View>
          ...
          <View style={styles.statusSection}>
            <View style={styles.statusRow}>
              <View style={[
                ...
                <Ionicons 
                  name={accesorio.enPromocion ? 'pricetag' : 'pricetag-outline'} 
                  size={20} 
                ...
                <Text style={[
                  ...
                  {accesorio.enPromocion ? 'EN PROMOCIÓN' : 'PRECIO NORMAL'}
                </Text>
              </View>
              ...
              <View style={[
                ...
                <Ionicons 
                  name={totalStock > 0 ? 'cube' : 'cube-outline'} 
                  size={20} 
                  color="#FFFFFF" 
                />
          ...
          <View style={styles.section}>
            ...
            <View style={styles.sectionContent}>
              ...
              {accesorio.linea && renderDetailField(
                'bookmark', 
                'Línea de producto', 
                accesorio.linea,
                '#00BCD4'
          ...
          <View style={styles.section}>
            ...
            <View style={styles.sectionContent}>
              ...
              {renderDetailField(
                'card', 
                'Precio actual', 
                formatPrice(accesorio.precioActual || accesorio.precioBase),
                accesorio.enPromocion ? '#FF9800' : '#4CAF50'
              )}
              {accesorio.enPromocion && accesorio.promocionId && renderDetailField(
                'pricetag', 
                'Promoción aplicada', 
                accesorio.promocionId?.nombre || 'Promoción activa',
                '#FF9800'
              )}
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.sectionContent}>
              ...
              {Array.isArray(accesorio.sucursales) && accesorio.sucursales.length > 0 && (
                <View style={styles.sucursalesDetail}>
                  <Text style={styles.sucursalesTitle}>Stock por sucursal:</Text>
                  {accesorio.sucursales.map((sucursal, index) => (
          ...
          <View style={styles.section}>
            ...
            <View style={styles.systemInfo}>
              <View style={styles.systemInfoRow}>
                <Text style={styles.systemInfoLabel}>ID del accesorio:</Text>
                <Text style={styles.systemInfoValue}>
                  {accesorio._id ? accesorio._id.slice(-8) : 'N/A'}
                </Text>
              </View>
              ...
              <View style={styles.systemInfoRow}>
                ...
                <Text style={styles.systemInfoValue}>
                  {formatDate(accesorio.createdAt)}
                </Text>
              </View>
              <View style={styles.systemInfoDivider} />
              <View style={styles.systemInfoRow}>
                ...
                <Text style={styles.systemInfoValue}>
                  {accesorio.imagenes?.length || 0} imagen(es)
                </Text>
              </View>
            </View>
          </View>
...
export default AccesorioDetailModal;