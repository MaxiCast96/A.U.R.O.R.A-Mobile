...
const AddLenteModal = ({
  ...
  promociones = [],
  sucursales = [],
  materiales = [],        // Constantes hardcodeadas
  colores = [],           // Constantes hardcodeadas
  tiposLente = [],        // Constantes hardcodeadas
}) => {
  ...
  resetForm();
    ...
    const dataToSend = {
      ...
      precioActual: form.enPromocion ? Number(form.precioActual) : Number(form.precioBase),
      medidas: {
        anchoPuente: Number(form.medidas.anchoPuente),
        altura: Number(form.medidas.altura),
        ancho: Number(form.medidas.ancho),
      },
      sucursales: form.sucursales.map(s => ({
        ...s,
